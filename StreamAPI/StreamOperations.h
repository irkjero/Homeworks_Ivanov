...
#ifndef STREAMAPI_STREAMOPERATIONS_H
#define STREAMAPI_STREAMOPERATIONS_H
#include <iostream>
#include "Stream.h"
#include "Streamexcept.h"

template<typename F, typename G> class Compose;
template<typename F> class Operator;
template<typename F> class Terminator;
...
#endif //STREAMAPI_STREAMOPERATIONS_H
